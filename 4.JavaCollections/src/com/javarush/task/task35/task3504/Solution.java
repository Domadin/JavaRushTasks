...
public class Solution <T extends HashMap> {
    ...
    public static void main(String[] args) {
        ...
        LinkedHashMap<Solution<HashMap<String, Integer>>, Solution<HashMap<String, Integer>>> hashMap2 = new LinkedHashMap<>();
        hashMap2.put(solution, solution);
        Solution<LinkedHashMap<Solution<HashMap<String, Integer>>, Solution<HashMap<String, Integer>>>> solution2 = new Solution<>(hashMap2);
